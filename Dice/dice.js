...
addEventListener("DOMContentLoaded", function (event) {
    var dices = [];
    var addDiceButton = document.getElementById("addDice");
    ...
    function rollDice(diceID) {
        return __awaiter(this, void 0, void 0, function () {
            var imgElement, j, i, diceValue;
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        imgElement = (_a = document.getElementById(diceID.toString())) === null || _a === void 0 ? void 0 : _a.querySelector("img");
                        j = 1;
                        _b.label = 1;
                    case 1:
    ...
    addDiceButton === null || addDiceButton === void 0 ? void 0 : addDiceButton.addEventListener("click", function () {
        ...
        var diceID = parseInt(nextDice.getAttribute("id"));
        diceContainer === null || diceContainer === void 0 ? void 0 : diceContainer.appendChild(nextDice);
        nextDice.addEventListener("click", function () { rollDice(diceID); });
    });
