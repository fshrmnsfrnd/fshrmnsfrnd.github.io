(function () {
  ...
  !(function () {
    var t, i, e, s, n, o, a;
    for (
      e = 0, n = (a = ["ms", "moz", "webkit", "o"]).length;
    ...
    (p = function () {
      var t, i, e;
      return (
        (e = (i = 1 <= arguments.length ? g.call(arguments, 0) : [])[0]),
        (t = i[1]),
        l(e.toFixed(t))
      );
    }),
    ...
    (t = (function (t) {
      ...
      return (
        ...
        (i.prototype.render = function () {
          ...
          return (
            (t = this.text
              ? d(this.displayedValue.toFixed(0))
              : l(p(this.displayedValue))),
    ...
    (o = (function (t) {
      ...
      return (
        ...
        (e.prototype.configPercentColors = function () {
          ...
          if (
            ...
            for (
              ...
              (a = parseInt(
                c(this.options.percentColors[e][1]).substring(0, 2),
                16
              )),
                (i = parseInt(
                  c(this.options.percentColors[e][1]).substring(2, 4),
                  16
                )),
                (t = parseInt(
                  c(this.options.percentColors[e][1]).substring(4, 6),
                  16
                )),
                o.push(
        ...
        (e.prototype.set = function (t) {
          ...
          for (
            t instanceof Array || (t = [t]), s = n = 0, l = t.length - 1;
            0 <= l ? n <= l : n >= l;
            s = 0 <= l ? ++n : --n
          )
            t[s] = this.parseValue(t[s]);
          if (t.length > this.gp.length)
            for (
              s = o = 0, c = t.length - this.gp.length;
              0 <= c ? o < c : o > c;
              s = 0 <= c ? ++o : --o
            )
              (e = new a(this)).setOptions(this.options.pointer),
                this.gp.push(e);
          else
        ...
        (e.prototype.render = function () {
          ...
          if (
            ...
            this.options.staticLabels &&
              this.renderStaticLabels(this.options.staticLabels, f, e, l),
            ...
            for (
              this.ctx.save(),
                ...
                s = 0,
                o = (c = this.options.staticZones).length;
              s < o;
              s++
            )
              (r = (x = c[s]).min),
                ...
                x.height &&
                  ...
                  (u = (this.lineWidth / 2) * (x.offset || 1 - x.height)),
                  (m = this.radius * this.options.radiusScale + u)),
            ...
            void 0 !== this.options.customFillStyle
              ...
              ? (0 === this.options.gradientType
                  ? ((d = l - this.lineWidth / 2),
                    (g = l + this.lineWidth / 2),
                    (i = this.ctx.createRadialGradient(f, e, d, f, e, g)))
                  : (i = this.ctx.createLinearGradient(0, 0, f, 0)),
          ...
          for (
            this.options.renderTicks &&
              this.renderTicks(this.options.renderTicks, f, e, l),
              this.ctx.restore(),
              this.ctx.translate(f, e),
              n = 0,
              a = (p = this.gp).length;
      ...
      return (
        ...
        (e.prototype.render = function () {
          ...
          return (
            ...
            (i = this.ctx.createRadialGradient(o, e, s, o, e, n)).addColorStop(
              0,
    ...
    (i = {
      ...
      addAll: function (t) {
        var e, s, n, o;
        for (o = [], s = 0, n = t.length; s < n; s++)
          (e = t[s]), o.push(i.elements.push(e));
        return o;
      },
      add: function (t) {
      ...
      run: function (t) {
        ...
        if ((null == t && (t = !1), isFinite(parseFloat(t)) || !0 === t)) {
          for (
            e = !0, r = [], n = s = 0, a = (h = i.elements).length;
            s < a;
            n = ++s
          )
            h[n].update(!0 === t) ? (e = !1) : r.push(n);
          for (o = r.length - 1; o >= 0; o += -1)
            (n = r[o]), i.elements.splice(n, 1);
          return (i.animId = e ? null : requestAnimationFrame(i.run));
        }
        if (!1 === t)
          return (
            !0 === i.animId && cancelAnimationFrame(i.animId),
            (i.animId = requestAnimationFrame(i.run))
          );
      },
    }),
